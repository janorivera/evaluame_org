...
// require_once( '/var/www/html/MVCProjectCodeIgniter/vendor/facebook/php-sdk-v4//autoload.php' );
...
class Facebook {
	 ...
	 * Returns the login URL.
	 */
	public function logout_url($fbSession, $next) {
		return $this->helper->getLogoutUrl ( $fbSession, $next );
	}
