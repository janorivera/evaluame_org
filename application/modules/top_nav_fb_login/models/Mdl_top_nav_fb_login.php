...
function insert_fb_user($fbUser){
	...
	if (array_key_exists('email',$fbUser))$user['Email']=$fbUser['email'];
	if (array_key_exists('gender',$fbUser))$user['Gender']=$fbUser['gender'];
	...
	if (array_key_exists('location',$fbUser))$user['Location']=$fbUser['location']->name;
	$user['State'] = true;
